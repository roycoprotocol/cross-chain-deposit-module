...
contract Test_BridgeDeposits_DepositLocker is RecipeMarketHubTestBase {
    ...
    function test_Bridge_wETH_Deposits(uint256 offerAmount, uint256 numDepositors) external {
        ...
        DepositLocker depositLocker = new DepositLocker(
            OWNER_ADDRESS, 30_280, address(0xbeef), 200_000, GREEN_LIGHTER_ADDRESS, recipeMarketHub, UNISWAP_V2_MAINNET_ROUTER_ADDRESS, lzV2OFTs
        );
    ...
    function test_Bridge_wBTC_Deposits(uint256 offerAmount, uint256 numDepositors) external {
        ...
        DepositLocker depositLocker = new DepositLocker(
            OWNER_ADDRESS, 30_106, address(0xbeef), 200_000, GREEN_LIGHTER_ADDRESS, recipeMarketHub, UNISWAP_V2_MAINNET_ROUTER_ADDRESS, lzV2OFTs
        );
