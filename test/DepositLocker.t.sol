...
contract Test_DepositsAndWithdrawals_DepositLocker is RecipeMarketHubTestBase {
    ...
    function setUp() external {
        ...
        depositLocker = new DepositLocker(OWNER_ADDRESS, 0, address(0), recipeMarketHub, IWETH(WETH_MAINNET_ADDRESS), UNISWAP_V2_MAINNET_ROUTER_ADDRESS, depositTokens, lzV2OFTs);
